	...
	public class TemperatureBehavior : BaseTemperatureBehavior
	{
	    ...
	    private bool Check()
        {
            ...
            using (var sw = new StreamWriter(_mbp.CheckPath))
            {
                ...
                {
                    sw.WriteLine("Fatal: Nlx = %g is less than -Leff.".FormatString(Param.BSIM3nlx));
                    CircuitWarning.Warning(this, "Fatal: Nlx = %g is less than -Leff.".FormatString(Param.BSIM3nlx));
                    fatal = true;
                }

                if (_mbp.Tox <= 0.0)
                {
                    sw.WriteLine("Fatal: Tox = %g is not positive.".FormatString(_mbp.Tox));
                    CircuitWarning.Warning(this, "Fatal: Tox = %g is not positive.".FormatString(_mbp.Tox));
                    fatal = true;
                }

                if (_mbp.Toxm <= 0.0)
                {
                    sw.WriteLine("Fatal: Toxm = %g is not positive.".FormatString(_mbp.Toxm));
                    CircuitWarning.Warning(this, "Fatal: Toxm = %g is not positive.".FormatString(_mbp.Toxm));
                    fatal = true;
                }

                if (_mbp.Lintnoi > Param.BSIM3leff / 2)
                {
                    sw.WriteLine("Fatal: Lintnoi = %g is too large - Leff for noise is negative.".FormatString(_mbp.Lintnoi));
                    CircuitWarning.Warning(this,
                        "Fatal: Lintnoi = %g is too large - Leff for noise is negative.".FormatString(_mbp.Lintnoi));
                    fatal = true;
                }

                if (Param.BSIM3npeak <= 0.0)
                {
                    sw.WriteLine("Fatal: Nch = %g is not positive.".FormatString(Param.BSIM3npeak));
                    CircuitWarning.Warning(this, "Fatal: Nch = %g is not positive.".FormatString(Param.BSIM3npeak));
                    fatal = true;
                }
                if (Param.BSIM3nsub <= 0.0)
                {
                    sw.WriteLine("Fatal: Nsub = %g is not positive.".FormatString(Param.BSIM3nsub));
                    CircuitWarning.Warning(this, "Fatal: Nsub = %g is not positive.".FormatString(Param.BSIM3nsub));
                    fatal = true;
                }
                if (Param.BSIM3ngate < 0.0)
                {
                    sw.WriteLine("Fatal: Ngate = %g is not positive.".FormatString(Param.BSIM3ngate));
                    CircuitWarning.Warning(this, "Fatal: Ngate = %g Ngate is not positive.".FormatString(Param.BSIM3ngate));
                    fatal = true;
                }
                if (Param.BSIM3ngate > 1.0e25)
                {
                    sw.WriteLine("Fatal: Ngate = %g is too high.".FormatString(Param.BSIM3ngate));
                    CircuitWarning.Warning(this, "Fatal: Ngate = %g Ngate is too high".FormatString(Param.BSIM3ngate));
                    fatal = true;
                }
                if (Param.BSIM3xj <= 0.0)
                {
                    sw.WriteLine("Fatal: Xj = %g is not positive.".FormatString(Param.BSIM3xj));
                    CircuitWarning.Warning(this, "Fatal: Xj = %g is not positive.".FormatString(Param.BSIM3xj));
                    fatal = true;
                }

                if (Param.BSIM3dvt1 < 0.0)
                {
                    sw.WriteLine("Fatal: Dvt1 = %g is negative.".FormatString(Param.BSIM3dvt1));
                    CircuitWarning.Warning(this, "Fatal: Dvt1 = %g is negative.".FormatString(Param.BSIM3dvt1));
                    fatal = true;
                }

                if (Param.BSIM3dvt1w < 0.0)
                {
                    sw.WriteLine("Fatal: Dvt1w = %g is negative.".FormatString(Param.BSIM3dvt1w));
                    CircuitWarning.Warning(this, "Fatal: Dvt1w = %g is negative.".FormatString(Param.BSIM3dvt1w));
                    fatal = true;
                }
                ...
                {
                    sw.WriteLine("Fatal: Dsub = %g is negative.".FormatString(Param.BSIM3dsub));
                    CircuitWarning.Warning(this, "Fatal: Dsub = %g is negative.".FormatString(Param.BSIM3dsub));
                    fatal = true;
                }
                ...
                {
                    sw.WriteLine("Fatal: u0 at current temperature = %g is not positive.".FormatString(Param.BSIM3u0temp));
                    CircuitWarning.Warning(this, "Fatal: u0 at current temperature = %g is not positive.".FormatString(Param.BSIM3u0temp));
                    fatal = true;
                }
                ...
                {
                    sw.WriteLine("Fatal: Delta = %g is less than zero.".FormatString(Param.BSIM3delta));
                    CircuitWarning.Warning(this, "Fatal: Delta = %g is less than zero.".FormatString(Param.BSIM3delta));
                    fatal = true;
                }

                if (Param.BSIM3vsattemp <= 0.0)
                {
                    sw.WriteLine("Fatal: Vsat at current temperature = %g is not positive.".FormatString(Param.BSIM3vsattemp));
                    CircuitWarning.Warning(this, "Fatal: Vsat at current temperature = %g is not positive.".FormatString(Param.BSIM3vsattemp));
                    fatal = true;
                }
                /* Check Rout parameters */
                if (Param.BSIM3pclm <= 0.0)
                {
                    sw.WriteLine("Fatal: Pclm = %g is not positive.".FormatString(Param.BSIM3pclm));
                    CircuitWarning.Warning(this, "Fatal: Pclm = %g is not positive.".FormatString(Param.BSIM3pclm));
                    fatal = true;
                }

                if (Param.BSIM3drout < 0.0)
                {
                    sw.WriteLine("Fatal: Drout = %g is negative.".FormatString(Param.BSIM3drout));
                    CircuitWarning.Warning(this, "Fatal: Drout = %g is negative.".FormatString(Param.BSIM3drout));
                    fatal = true;
                }

                if (Param.BSIM3pscbe2 <= 0.0)
                {
                    sw.WriteLine("Warning: Pscbe2 = %g is not positive.".FormatString(Param.BSIM3pscbe2));
                    CircuitWarning.Warning(this, "Warning: Pscbe2 = %g is not positive.".FormatString(Param.BSIM3pscbe2));
                }

                if (Param.BSIM3noff < 0.1)
                {
                    sw.WriteLine("Warning: Noff = %g is too small.".FormatString(Param.BSIM3noff));
                    CircuitWarning.Warning(this, "Warning: Noff = %g is too small.".FormatString(Param.BSIM3noff));
                }
                if (Param.BSIM3noff > 4.0)
                {
                    sw.WriteLine("Warning: Noff = %g is too large.".FormatString(Param.BSIM3noff));
                    CircuitWarning.Warning(this, "Warning: Noff = %g is too large.".FormatString(Param.BSIM3noff));
                }

                if (Param.BSIM3voffcv < -0.5)
                {
                    sw.WriteLine("Warning: Voffcv = %g is too small.".FormatString(Param.BSIM3voffcv));
                    CircuitWarning.Warning(this, "Warning: Voffcv = %g is too small.".FormatString(Param.BSIM3voffcv));
                }
                if (Param.BSIM3voffcv > 0.5)
                {
                    sw.WriteLine("Warning: Voffcv = %g is too large.".FormatString(Param.BSIM3voffcv));
                    CircuitWarning.Warning(this, "Warning: Voffcv = %g is too large.".FormatString(Param.BSIM3voffcv));
                }

                if (_mbp.Ijth < 0.0)
                {
                    sw.WriteLine("Fatal: Ijth = %g cannot be negative.".FormatString(_mbp.Ijth));
                    CircuitWarning.Warning(this, "Fatal: Ijth = %g cannot be negative.".FormatString(_mbp.Ijth));
                    fatal = true;
                }
                ...
                {
                    sw.WriteLine("Fatal: Clc = %g is negative.".FormatString(Param.BSIM3clc));
                    CircuitWarning.Warning(this, "Fatal: Clc = %g is negative.".FormatString(Param.BSIM3clc));
                    fatal = true;
                }

                if (Param.BSIM3moin < 5.0)
                {
                    sw.WriteLine("Warning: Moin = %g is too small.".FormatString(Param.BSIM3moin));
                    CircuitWarning.Warning(this, "Warning: Moin = %g is too small.".FormatString(Param.BSIM3moin));
                }
                if (Param.BSIM3moin > 25.0)
                {
                    sw.WriteLine("Warning: Moin = %g is too large.".FormatString(Param.BSIM3moin));
                    CircuitWarning.Warning(this, "Warning: Moin = %g is too large.".FormatString(Param.BSIM3moin));
                }
                ...
                if (_mbp.CapMod == 3)
                {
                    ...
                    {
                        sw.WriteLine("Warning:  Acde = %g is too small.".FormatString(Param.BSIM3acde));
                        CircuitWarning.Warning(this, "Warning: Acde = %g is too small.".FormatString(Param.BSIM3acde));
                    }
                    if (Param.BSIM3acde > 1.6)
                    {
                        sw.WriteLine("Warning:  Acde = %g is too large.".FormatString(Param.BSIM3acde));
                        CircuitWarning.Warning(this, "Warning: Acde = %g is too large.".FormatString(Param.BSIM3acde));
                    }
                }
                ...
                if (_mbp.ParamChk == 1)
                {
                    ...
                    {
                        sw.WriteLine("Warning: Leff = %g may be too small.".FormatString(Param.BSIM3leff));
                        CircuitWarning.Warning(this, "Warning: Leff = %g may be too small.".FormatString(Param.BSIM3leff));
                    }

                    if (Param.BSIM3leffCV <= 5.0e-8)
                    {
                        sw.WriteLine("Warning: Leff for CV = %g may be too small.".FormatString(Param.BSIM3leffCV));
                        CircuitWarning.Warning(this, "Warning: Leff for CV = %g may be too small.".FormatString(Param.BSIM3leffCV));
                    }

                    if (Param.BSIM3weff <= 1.0e-7)
                    {
                        sw.WriteLine("Warning: Weff = %g may be too small.".FormatString(Param.BSIM3weff));
                        CircuitWarning.Warning(this, "Warning: Weff = %g may be too small.".FormatString(Param.BSIM3weff));
                    }

                    if (Param.BSIM3weffCV <= 1.0e-7)
                    {
                        sw.WriteLine("Warning: Weff for CV = %g may be too small.".FormatString(Param.BSIM3weffCV));
                        CircuitWarning.Warning(this, "Warning: Weff for CV = %g may be too small.".FormatString(Param.BSIM3weffCV));
                    }

                    /* Check threshold voltage parameters */
                    if (Param.BSIM3nlx < 0.0)
                    {
                        sw.WriteLine("Warning: Nlx = %g is negative.".FormatString(Param.BSIM3nlx));
                        CircuitWarning.Warning(this, "Warning: Nlx = %g is negative.".FormatString(Param.BSIM3nlx));
                    }
                    if (_mbp.Tox < 1.0e-9)
                    {
                        sw.WriteLine("Warning: Tox = %g is less than 10A.".FormatString(_mbp.Tox));
                        CircuitWarning.Warning(this, "Warning: Tox = %g is less than 10A.".FormatString(_mbp.Tox));
                    }

                    if (Param.BSIM3npeak <= 1.0e15)
                    {
                        sw.WriteLine("Warning: Nch = %g may be too small.".FormatString(Param.BSIM3npeak));
                        CircuitWarning.Warning(this, "Warning: Nch = %g may be too small.".FormatString(Param.BSIM3npeak));
                    }
                    else if (Param.BSIM3npeak >= 1.0e21)
                    {
                        sw.WriteLine("Warning: Nch = %g may be too large.".FormatString(Param.BSIM3npeak));
                        CircuitWarning.Warning(this, "Warning: Nch = %g may be too large.".FormatString(Param.BSIM3npeak));
                    }

                    if (Param.BSIM3nsub <= 1.0e14)
                    {
                        sw.WriteLine("Warning: Nsub = %g may be too small.".FormatString(Param.BSIM3nsub));
                        CircuitWarning.Warning(this, "Warning: Nsub = %g may be too small.".FormatString(Param.BSIM3nsub));
                    }
                    else if (Param.BSIM3nsub >= 1.0e21)
                    {
                        sw.WriteLine("Warning: Nsub = %g may be too large.".FormatString(Param.BSIM3nsub));
                        CircuitWarning.Warning(this, "Warning: Nsub = %g may be too large.".FormatString(Param.BSIM3nsub));
                    }

                    if ((Param.BSIM3ngate > 0.0) && (Param.BSIM3ngate <= 1.0e18))
                    {
                        sw.WriteLine("Warning: Ngate = %g is less than 1.E18cm^-3.".FormatString(Param.BSIM3ngate));
                        CircuitWarning.Warning(this, "Warning: Ngate = %g is less than 1.E18cm^-3.".FormatString(Param.BSIM3ngate));
                    }

                    if (Param.BSIM3dvt0 < 0.0)
                    {
                        sw.WriteLine("Warning: Dvt0 = %g is negative.".FormatString(Param.BSIM3dvt0));
                        CircuitWarning.Warning(this, "Warning: Dvt0 = %g is negative.".FormatString(Param.BSIM3dvt0));
                    }
                    ...
                    {
                        sw.WriteLine("Warning: Nfactor = %g is negative.".FormatString(Param.BSIM3nfactor));
                        CircuitWarning.Warning(this, "Warning: Nfactor = %g is negative.".FormatString(Param.BSIM3nfactor));
                    }
                    if (Param.BSIM3cdsc < 0.0)
                    {
                        sw.WriteLine("Warning: Cdsc = %g is negative.".FormatString(Param.BSIM3cdsc));
                        CircuitWarning.Warning(this, "Warning: Cdsc = %g is negative.".FormatString(Param.BSIM3cdsc));
                    }
                    if (Param.BSIM3cdscd < 0.0)
                    {
                        sw.WriteLine("Warning: Cdscd = %g is negative.".FormatString(Param.BSIM3cdscd));
                        CircuitWarning.Warning(this, "Warning: Cdscd = %g is negative.".FormatString(Param.BSIM3cdscd));
                    }
                    /* Check DIBL parameters */
                    if (Param.BSIM3eta0 < 0.0)
                    {
                        sw.WriteLine("Warning: Eta0 = %g is negative.".FormatString(Param.BSIM3eta0));
                        CircuitWarning.Warning(this, "Warning: Eta0 = %g is negative.".FormatString(Param.BSIM3eta0));
                    }
                    ...
                    {
                        sw.WriteLine("Warning: A2 = %g is too small. Set to 0.01.".FormatString(Param.BSIM3a2));
                        CircuitWarning.Warning(this, "Warning: A2 = %g is too small. Set to 0.01.".FormatString(Param.BSIM3a2));
                        Param.BSIM3a2 = 0.01;
                    }
                    else if (Param.BSIM3a2 > 1.0)
                    {
                        sw.WriteLine("Warning: A2 = %g is larger than 1. A2 is set to 1 and A1 is set to 0.".FormatString(Param.BSIM3a2));
                        CircuitWarning.Warning(this, "Warning: A2 = %g is larger than 1. A2 is set to 1 and A1 is set to 0.".FormatString(Param.BSIM3a2));
                        Param.BSIM3a2 = 1.0;
                        Param.BSIM3a1 = 0.0;
                    }
                    ...
                    {
                        sw.WriteLine("Warning: Rdsw = %g is negative. Set to zero.".FormatString(Param.BSIM3rdsw));
                        CircuitWarning.Warning(this, "Warning: Rdsw = %g is negative. Set to zero.".FormatString(Param.BSIM3rdsw));
                        Param.BSIM3rdsw = 0.0;
                        Param.BSIM3rds0 = 0.0;
                    }
                    if (Param.BSIM3rds0 < 0.0)
                    {
                        sw.WriteLine("Warning: Rds at current temperature = %g is negative. Set to zero.".FormatString(Param.BSIM3rds0));
                        CircuitWarning.Warning(this, "Warning: Rds at current temperature = %g is negative. Set to zero.".FormatString(Param.BSIM3rds0));
                        Param.BSIM3rds0 = 0.0;
                    }

                    if (Param.BSIM3vsattemp < 1.0e3)
                    {
                        sw.WriteLine("Warning: Vsat at current temperature = %g may be too small.".FormatString(Param.BSIM3vsattemp));
                        CircuitWarning.Warning(this, "Warning: Vsat at current temperature = %g may be too small.".FormatString(Param.BSIM3vsattemp));
                    }

                    if (Param.BSIM3pdibl1 < 0.0)
                    {
                        sw.WriteLine("Warning: Pdibl1 = %g is negative.".FormatString(Param.BSIM3pdibl1));
                        CircuitWarning.Warning(this, "Warning: Pdibl1 = %g is negative.".FormatString(Param.BSIM3pdibl1));
                    }
                    if (Param.BSIM3pdibl2 < 0.0)
                    {
                        sw.WriteLine("Warning: Pdibl2 = %g is negative.".FormatString(Param.BSIM3pdibl2));
                        CircuitWarning.Warning(this, "Warning: Pdibl2 = %g is negative.".FormatString(Param.BSIM3pdibl2));
                    }
                    /* Check overlap capacitance parameters */
                    if (_mbp.Cgdo < 0.0)
                    {
                        sw.WriteLine("Warning: cgdo = %g is negative. Set to zero.".FormatString(_mbp.Cgdo));
                        CircuitWarning.Warning(this, "Warning: cgdo = %g is negative. Set to zero.".FormatString(_mbp.Cgdo));
                        _mbp.Cgdo.RawValue = 0.0;
                    }
                    if (_mbp.Cgso < 0.0)
                    {
                        sw.WriteLine("Warning: cgso = %g is negative. Set to zero.".FormatString(_mbp.Cgso));
                        CircuitWarning.Warning(this, "Warning: cgso = %g is negative. Set to zero.".FormatString(_mbp.Cgso));
                        _mbp.Cgso.RawValue = 0.0;
                    }
                    if (_mbp.Cgbo < 0.0)
                    {
                        sw.WriteLine("Warning: cgbo = %g is negative. Set to zero.".FormatString(_mbp.Cgbo));
                        CircuitWarning.Warning(this, "Warning: cgbo = %g is negative. Set to zero.".FormatString(_mbp.Cgbo));
