...
{
    /// <summary>
    /// Model parameters for a <see cref="BSIM3v1Model"/>
    /// </summary>
    [GeneratedParameters]
    public partial class ModelParameters : ParameterSet<ModelParameters>
    {
        ...
        public string CheckPath { get; set; } = "b3v1check.log";

        [ParameterName("capmod"), ParameterInfo("Capacitance model selector")]
        private GivenParameter<int> _capMod = new GivenParameter<int>(2);
        ...
        [Finite]
        private GivenParameter<double> _version = new GivenParameter<double>(3.1);
        ...
        [ParameterName("hdif"), ParameterInfo("S/D junction extension")]
        [Finite]
