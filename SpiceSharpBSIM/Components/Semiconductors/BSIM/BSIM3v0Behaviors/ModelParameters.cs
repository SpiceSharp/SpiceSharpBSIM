...
{
    /// <summary>
    /// Model parameters for a <see cref="BSIM3v0Model"/>
    /// </summary>
    [GeneratedParameters]
    public partial class ModelParameters : ParameterSet<ModelParameters>
    {
        ...
        private GivenParameter<int> _capMod = new GivenParameter<int>(1);

        [ParameterName("nqsmod"), ParameterInfo("Non-quasi-static model selector")]
        private GivenParameter<int> _nqsMod = new GivenParameter<int>(0);
        ...
        [Finite]
        private GivenParameter<double> _vbm = new GivenParameter<double>(-5.0);
        ...
        [Finite]
        public GivenParameter<double> U0
        {
            get => _u0;
            set
            {
                Utility.Finite(value, nameof(U0));
                if (value > 1.0)
                    _u0 = value * 1.0e-4;
                else
                    _u0 = value;
        ...
        [Finite]
        private GivenParameter<double> _cgbo = new GivenParameter<double>(0.0);
        ...
        [ParameterName("cjsw"), ParameterInfo("Source/drain sidewall junction capacitance per unit area")]
        [Finite]
        ...
        [Finite]
        private GivenParameter<double> _ldvt0w = new GivenParameter<double>(0.0, false);

        // Correction 20220726 - Sven Boulanger
        [ParameterName("ldvt1w"), ParameterInfo("Length dependence of dvt1w")]
        [Finite]
        private GivenParameter<double> _ldvt1w = new GivenParameter<double>(0.0, false);

        // Correction 20220726 - Sven Boulanger
        [ParameterName("ldvt2w"), ParameterInfo("Length dependence of dvt2w")]
        [Finite]
        private GivenParameter<double>  _ldvt2w = new GivenParameter<double>(0.0, false);
        ...
        [Finite]
        public GivenParameter<double> Lu0
        {
            get => _lu0;
            set
            {
                Utility.Finite(value, nameof(Lu0));
                if (value > 1.0)
                    _lu0 = value * 1.0e-4;
                else
                    _lu0 = value;
        ...
        [Finite]
        public GivenParameter<double> Wu0
        {
            get => _wu0;
            set
            {
                Utility.Finite(value, nameof(Wu0));
                if (value > 1.0)
                    _wu0 = value * 1.0e-4;
                else
                    _wu0 = value;
        ...
        [Finite]
        public GivenParameter<double> Pu0
        {
            get => _pu0;
            set
            {
                Utility.Finite(value, nameof(Pu0));
                if (value > 1.0)
                    _pu0 = value * 1.0e-4;
                else
                    _pu0 = value;
