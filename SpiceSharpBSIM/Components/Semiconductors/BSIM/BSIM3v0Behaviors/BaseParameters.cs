...
{
    /// <summary>
    /// Parameters for a <see cref="BSIM3v0"/>.
    /// </summary>
    [GeneratedParameters]
    public partial class BaseParameters : ParameterSet<BaseParameters>
    {
        ...
        [Finite]
        private GivenParameter<double> _sourceArea = new GivenParameter<double>(0);
        ...
        [Finite]
        private GivenParameter<double> _sourcePerimeter = new GivenParameter<double>(0);
