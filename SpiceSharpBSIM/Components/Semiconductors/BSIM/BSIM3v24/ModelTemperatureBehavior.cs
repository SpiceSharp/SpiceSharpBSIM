...
namespace SpiceSharp.Components.BSIM3v24Behaviors
{
    ...
    public class ModelTemperatureBehavior : Behavior, ITemperatureBehavior
    {
        ...
        /// </summary>
        public Dictionary<Tuple<double, double>, BSIM3SizeDependParams> SizeDependParams { get; } =
            new Dictionary<Tuple<double, double>, BSIM3SizeDependParams>();
        ...
        void ITemperatureBehavior.Temperature()
        {
            ...
            // Often both temperatures are the same, so this can save a few computations
            if (!temp.Equals(tnom))
            {
